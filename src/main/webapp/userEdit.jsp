  ...
  <div class="card border-info mb-3" style="max-width: 28rem;">
    ...
    <div class="card-body"><span id="info"></span>
      ...
      <div class="mb-3">
          ...
          <input type="text" class="form-control"  name="firstname" id="fname" onblur="forfname()" value="${userDTO.firstname}">
        </div>
        
        <div class="mb-3">
          <label for="lastName" class="form-label" style="margin-right: 290px;">Last-Name</label><br><span id="validLastName"></span>
          <input type="text" class="form-control"  name="lastname" id="lastname" onblur="forLastname()" value="${userDTO.lastname }">
        </div>
        
        <div class="mb-3">
          <label for="emailid" class="form-label" style="margin-right: 280px;">Email address</label><br><span id="validemail"></span>
          <input type="email" class="form-control" name="emailid" id="emailid" onblur="forEmailvalidation()" value="${userDTO.emailid }">
        ...
        <div class="mb-3">
          ...
          <input type="date" class="form-control" id="dateofbirth" name="dateOfBirth" value="${userDTO.dateOfBirth }">
        </div>
        
        <div class="mb-3">
          <label for="Address" class="form-label" style="margin-right: 290px;">Address</label><br><span id="foraddress"></span>
          <input type="text" class="form-control" id="address" name="address" onblur="AddressValidation()" value="${userDTO.address }">
        </div>
        
        <div class="mb-3">
          <label for="state" class="form-label" style="margin-right: 290px;">State</label><br><span id="forstate"></span>
          <input type="text" class="form-control" id="state" name="state" onblur="stateValidation()" value="${userDTO.state }">
        </div>
        
        <div class="mb-3">
          <label for="pincode" class="form-label" style="margin-right: 290px;">Pincode</label><br><span id="forpins"></span>
          <input type="number" class="form-control" id="pincode" name="pincode" onblur="pinvalidation()" value="${userDTO.pincode }">
        </div>
        
        <div class="mb-3">
          <label for="password" class="form-label" style="margin-right: 290px;">Password</label><br><span id="forPassword"></span>
          <input type="password" class="form-control" id="password" name="password" onblur="passwordvalidation()" value="${userDTO.password }">
        </div>
        ...
        <div class="mb-3">
          ...
          <input type="password" class="form-control" id="conformpassword" name="conformpassword" onblur="conformpasswordvalidation()" value="${userDTO.conformpassword }">
        </div>
