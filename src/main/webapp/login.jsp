...
<body>
					...
					<form action="userLogin" method="post" onclick="form()">
						...
						<div class="mb-3">
							...
							<input type="email" class="form-control" name="emailid" id="emailid"
								onblur="forEmailvalidation()" value="${username}">
						...
						<div class="mb-3">
				<label for="password" class="form-label" style="margin-right: 290px;">Password</label><br><span style="color: red";>${perror }</span>
							<span id="forPassword"></span> <input type="password" class="form-control" id="password" name="password"
								onblur="passwordvalidation()">
						</div>

                         
						<a href="changePassword.jsp" style="margin-left: -20px">forgate password</a>
	...
	<script>
		...
		function passwordvalidation() {
			...
			var button = document.getElementById("button");
			if (passwords.length != "" && passwords.length >= 5
					&& passwords.length <= 25) {
		...
		function form() {
			...
			var button = document.getElementById("button");
			if (emailid.lenght != "" && emailid.length >= 5
					&& emailid.length <= 100 && passwords.length != ""
					&& passwords.length >= 5 && passwords.length <= 25) {
